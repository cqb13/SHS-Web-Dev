    ...
    <main className='flex flex-col flex-1'>
      <section className='flex-grow flex px-4 py-2'>
        <section className='flex-1 flex flex-col items-center justify-center'>
          ...
          <p className='w-3/5 text-center text-xl max-lg:w-full'>
            Join us at our bi-monthly meetings on Wednesdays in room 2411 to
            learn and practice web development.
          </p>
          <Link
            href='/about'
            className='mt-10 px-32 py-10 text-2xl bg-dark text-center font-semibold rounded-md hover:bg-light hover:rounded-xl transition-all ease-in-out active:tracking-wider max-md-lg:px-24'
          >
            Learn More
          </Link>
        </section>
        <section className='flex items-center justify-center shrink-0'>
          <svg
            className='max-sm:hidden max-md-lg:w-[300px] max-md-lg:h-[300px]'
            width='450'
            height='450'
            viewBox='0 0 225 225'
            fill='none'
