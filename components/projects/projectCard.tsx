  ...
  return (
    <section className='flex flex-col bg-light rounded-md p-4 h-60 justify-between max-xs:h-72'>
      ...
      <div className="flex gap-2 justify-between">
        <a href={url} target='_blank' className="bg-highlight rounded-md p-2 hover:opacity-90 hover:rounded-lg transition-all ease-in-out text-center">
          View Repo
        </a>
        {homepage ? (
          <a href={homepage} target='_blank' className="bg-highlight rounded-md p-2 hover:opacity-90 hover:rounded-lg transition-all ease-in-out text-center">
            View Website
          </a>
        ) : null}
      </div>
